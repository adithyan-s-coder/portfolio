...
import { FiGithub, FiTwitter, FiLinkedin, FiInstagram, FiCpu, FiShield, FiActivity, FiArrowUpRight, FiMail, FiPhone } from 'react-icons/fi';
...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FiGithub />, label: 'GITHUB', url: 'https://github.com/adithyan-s-coder', color: 'hover:text-red-500' },
    { icon: <FiMail />, label: 'EMAIL', url: 'mailto:adithyannn.adhi@gmail.com', color: 'hover:text-cyan-400' },
    { icon: <FiLinkedin />, label: 'LINKEDIN', url: 'https://www.linkedin.com/in/adithyan-s-a30165376/', color: 'hover:text-blue-500' },
    { icon: <FiPhone />, label: 'PHONE', url: 'tel:+919345991300', color: 'hover:text-violet-500' },
  ];
          ...
          >
            <div className="flex items-center space-x-3 group cursor-pointer">
              ...
              <h3 className="text-2xl font-black text-white tracking-tighter uppercase italic">
                ADITHYAN<span className="text-cyan-600"> S</span>
              </h3>
            </div>
        ...
        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-end">
             ...
             <p className="text-[9px] text-gray-700 tracking-[0.2em] font-mono uppercase">
                &copy; ADITHYAN S. ALL NEURAL LINKS RESERVED.
             </p>
          </div>
        </div>
      </div>
